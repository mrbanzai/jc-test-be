...
require_once APPLICATION_PATH . '/library/PHPThumb/Factory.php';

// The path to your web root
$document_path = '/'.trim($_SERVER['DOCUMENT_ROOT'], '/').($_SERVER['DOCUMENT_ROOT']!=''?'/':'');

// The path to your cache folder
$cache_path = APPLICATION_PATH . '/data/phpthumb/';

// The URI to your cache folder
$cache_uri = 'http://'.trim($_SERVER['HTTP_HOST'], '/').'/cache/';

// How long caches should live. Remember, hard refreshes will also clear out your
// cache so you'll be safe setting this pretty high
$cache_life = '-1 month';
